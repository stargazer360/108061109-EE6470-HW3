...
// Blur filter Memory Map
// Used between SimpleBus & BlurFilter
const int BLUR_MM_BASE = 0x90000000;
const int BLUR_MM_SIZE = 0x0000000C;
const int BLUR_MM_MASK = 0x0000000F;
